                    ...
                    <form action="/invoices/{{$invoice->id}}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SlectBox" onclick="console.log($(this).val())" 
                                    ...
                                    @foreach ($sections as $section)
                                        <option value="{{ $section->id }}" {{$section->id==$invoice->section_id? 'selected':''}}> {{ $section->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col">
                                ...
                                @foreach ($products as $product)
                                   <option value="{{ $product->name}}" {{$invoice->product== $product->name? 'selected':''}}> {{ $product->name }}</option>
                                @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount" name="Discount" value="{{$invoice->Discount}}"
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $('select[name="product"]').empty();
                             $('select[name="product"]').append('<option selected disabled>حدد المنتج</option>');
