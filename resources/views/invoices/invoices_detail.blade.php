                                                    ...
                                                    <tbody>
                                                        @foreach ($details as $index=>$detail)
                                                            ...
                                                            <tr>
                                                                ...
                                                                @endif
                                                                <td>{{$detail->Amount_collection}}</td>
                                        ...
                                        <div class="tab-pane" id="tab6">
                                            ...
                                            <div class="card card-statistics">                                                
                                                    <div class="card-body">
                                                        ...
                                                        <form method="post" action="/attchments"
                                                            enctype="multipart/form-data">
                                                            @csrf
                                                            <div class="custom-file">
                                                                <input type="file" class="custom-file-input" id="customFile"
                                                                    name="file_name" required>
                                                                <input type="hidden" id="" name="invoice_number"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2">
                                                                        ...
                                                                        <a class="btn btn-outline-success btn-sm"
                                                                            href="/open/{{ $invoices->invoice_number }}/{{ $attachment->file_name }}"
    ...
    <div class="modal fade" id="delete_file" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/attchments/desteoy" method="post">
                   @method('delete')
                   @csrf
