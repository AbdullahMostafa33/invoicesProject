				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							...
							<li><a class="slide-item" href="/invoices?status=paid">الفواتير المدفوعة</a></li>
							<li><a class="slide-item" href="/invoices?status=unpaid">الفواتير الغير مدفوعة</a></li>
							<li><a class="slide-item" href="/invoices?status=partly">الفواتير المدفوعة جزئيا</a></li>
							<li><a class="slide-item" href="/invoices?status=3">الفواتير المؤرشفة</a></li>
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="/reports/invoices">تقارير الفواتير</a></li>
							<li><a class="slide-item" href="/reports/customers">تقارير العملاء</a></li>
...
@can('user list')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="/users">قائمة المستخدمين</a></li>
...
@can('setting')
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="/sections">الاقسام</a></li>
							<li><a class="slide-item" href="/products">المنتجات</a></li>
						</ul>
					</li>
